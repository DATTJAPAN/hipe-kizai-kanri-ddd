...
import OrgUnitDashboardDataTable from '@/pages/v1/org/unit/_datatable';
...
export default function OrgUnitDashboard() {
    return (
                        ...
                        <div className="flex flex-wrap items-center gap-2 bg-background py-2 shadow-sm">
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    ...
                                    >
                                        <Link href={route('v1.org.units.manage:get')}>
